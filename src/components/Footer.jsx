...
export default function Footer() {
  ...
  return (
    <footer className="fc-footer" style={{ display: 'flex', width: '100%' }}>
      {/* Navy column */}
      <div className="fc-footer-col-navy" style={{ background: '#033059', padding: '56px 64px', display: 'flex', flexDirection: 'column', gap: 40, flex: '0 0 380px' }}>
      ...
      {/* White column */}
      <div className="fc-footer-col-white" style={{ background: 'white', padding: '56px 64px', display: 'flex', flexDirection: 'column', gap: 40, flex: 1 }}>
        ...
        <div style={{ columns: 2, gap: 32 }}>
          {NAV_LINKS.map(([label, path]) => (
            <Link key={label} to={path} style={{ display: 'block', fontFamily: 'Montserrat, sans-serif', fontWeight: 500, fontSize: 14, color: '#575757', textDecoration: 'none', marginBottom: 10 }}>
              {label}
            </Link>
          ))}
        </div>
        <div style={{ borderTop: '1px solid #E3E3E3', paddingTop: 24 }}>
          <div style={{ fontSize: 11, fontFamily: 'Montserrat, sans-serif', fontWeight: 500, color: '#AAAAAA', display: 'flex', gap: 24, flexWrap: 'wrap' }}>
      ...
      <div className="fc-footer-col-gray" style={{ background: '#F5F5F5', padding: '56px 48px', display: 'flex', flexDirection: 'column', gap: 32, flex: 1 }}>
        ...
        <div style={{ display: 'flex', borderRadius: 48, overflow: 'hidden', border: '1px solid #E3E3E3', background: 'white' }}>
          <input
            ...
            style={{ flex: 1, padding: '14px 20px', border: 'none', outline: 'none', fontFamily: 'Montserrat, sans-serif', fontSize: 13, fontWeight: 500, color: '#033059', background: 'transparent', minWidth: 0 }}
          />
          <button style={{ padding: '14px 24px', background: '#033059', border: 'none', color: 'white', fontFamily: 'Montserrat, sans-serif', fontWeight: 600, fontSize: 13, cursor: 'pointer', borderRadius: '0 48px 48px 0', whiteSpace: 'nowrap' }}>
            S'inscrire
          </button>
        </div>
