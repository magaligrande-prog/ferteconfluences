export default function InnerHero({ title, subtitle, breadcrumb, img }) {
  return (
    <div style={{ position: 'relative', height: 500, background: `url(${img}) center/cover no-repeat`, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: 96, left: 48, display: 'flex', gap: 8, alignItems: 'center' }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
        <h1 style={{ fontFamily: 'agenda, Nunito, sans-serif', fontWeight: 500, fontSize: 80, letterSpacing: '-0.02em', color: 'white', lineHeight: 1, textAlign: 'center' }}>
          {title}
        </h1>
        {subtitle && (
